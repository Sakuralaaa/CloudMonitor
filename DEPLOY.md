# 🚀 Cloud Monitor 部署指南（Zeabur 示例）

本指南以 Zeabur 为例介绍部署流程，应用也可在 Vercel、Railway、Render 等支持 Node.js 的平台一键部署。
...
1. 访问项目仓库：https://github.com/Sakuralaaa/cloud-monitor
2. 点击右上角 **Fork** 按钮
...
- [项目 GitHub](https://github.com/Sakuralaaa/cloud-monitor)
